...
# from planners.graphnet import GraphNetPlanner # 如果有训练好的模型，取消注释并添加到选择逻辑中
...
def batch_gini(capital_matrix):
    ...
    """
    # 按行(局)排序资金
    sorted_cap, _ = torch.sort(capital_matrix, dim=1)
...
if __name__ == "__main__":
    ...
    run_average_simulation(n_games=args.n, strategy_name=args.strategy)